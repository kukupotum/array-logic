...
export function Index() {
  ...
  const handleClickArr = () => {
    // pemecah string menjadi array
    const pemecah = arr?.split(' ')
    // logic array sesuai kebutuhan
    const mapping = pemecah?.filter(val=> val?.length === 3)
    setResArr(mapping[0])
  }
  ...
  return (
  <div>
        <Component label="Array filter" value={arr} handleChange={handleChangeArray} handleClick={handleClickArr} result={resArr} />
